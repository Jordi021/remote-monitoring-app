...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void insertarTokenAutenticacionPorDefecto(SQLiteDatabase db) {
        ...
        valores.put(COLUMNA_TOKEN, "token_super_secret");
    ...
    public java.util.List<org.json.JSONObject> obtenerTodosDatosSensorComoLista() {
        java.util.List<org.json.JSONObject> listaJson = new java.util.ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
